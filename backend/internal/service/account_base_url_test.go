	...
	tests := []struct {
		...
		},
		{
			...
			account: Account{
				Type:        AccountTypeOAuth,
				Platform:    PlatformGrok,
				Credentials: map[string]any{"base_url": "HTTPS://API.X.AI:443/"},
			},
			expected: xai.DefaultCLIBaseURL,
		},
		{
			...
			account: Account{
				Type:        AccountTypeOAuth,
				Platform:    PlatformGrok,
				Credentials: map[string]any{"base_url": "https://api.x.ai:0443/v1"},
			},
			expected: xai.DefaultCLIBaseURL,
		},
		{
			...
			account: Account{
				Type:        AccountTypeOAuth,
				Platform:    PlatformGrok,
				Credentials: map[string]any{"base_url": "https://api.x.ai/%76%31"},
			},
			expected: xai.DefaultCLIBaseURL,
		},
		{
			...
			account: Account{
				Type:        AccountTypeOAuth,
				Platform:    PlatformGrok,
				Credentials: map[string]any{"base_url": "https://api.x.ai/v1%2F"},
			},
			expected: xai.DefaultCLIBaseURL,
		},
		{
			...
			account: Account{
				Type:        AccountTypeOAuth,
				Platform:    PlatformGrok,
				Credentials: map[string]any{"base_url": "https://api.x.ai:8443/v1"},
			},
